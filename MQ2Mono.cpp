...
void InitMono()
{
	...
	mono_add_internal_call("MonoCore.E3ImGUI::imgui_InvisibleButton", &mono_ImGUI_InvisibleButton);
	...
	mono_add_internal_call("MonoCore.E3ImGUI::imgui_GetTextLineHeight", &mono_ImGUI_GetTextLineHeight);
